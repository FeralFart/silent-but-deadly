...
| **plex/**      | Plex Media Server – Movie and TV streaming for local media libraries;<br>also includes related media management services such as: <br><br>qBittorrent (downloads),<br>Radarr (movie management),<br>Tautulli (monitoring and analytics). |
